    ...
    <div className="mx-auto max-w-5xl px-6 py-10">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3">
          ...
          <span className="rounded-full bg-green/10 border border-green/20 px-2.5 py-0.5 font-mono text-sm font-bold text-green">
      ...
      {latest && (
        <div className="mb-8">
          <p className="text-[13px] font-mono text-muted uppercase tracking-widest mb-3">latest review</p>
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-4 flex items-center gap-3">
                  <Link
                    ...
                    className="rounded-sm bg-foreground px-4 py-1.5 text-sm font-medium text-background transition-colors hover:bg-foreground/80"
                  >
                    read full review →
                  </Link>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="rounded-sm border border-border px-3 py-1.5 text-sm font-medium text-foreground transition-colors hover:bg-surface-hover"
                  >
                    try it yourself ↗
                  </a>
                </div>
      ...
      {items.length > 1 && (
        <>
          <p className="text-[13px] font-mono text-muted uppercase tracking-widest mb-3">all reviews</p>
              ...
              .map(({ project, review, snippet }) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    />
                    <div className="min-w-0 flex-1">
                      <h3 className="text-[15px] font-bold text-foreground group-hover:text-accent transition-colors truncate">
                        {project.name}
                      </h3>
                  ...
                  <span className="mt-3 inline-block rounded-sm bg-foreground px-2.5 py-1 text-[12px] font-medium text-background group-hover:bg-foreground/80 transition-colors">
                    read review →
                  </span>
                </Link>
              ))}
