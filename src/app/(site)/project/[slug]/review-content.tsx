    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 rounded-full border border-border px-3.5 py-1.5 text-sm font-medium text-muted transition-colors hover:text-foreground hover:border-foreground/30"
        >
      ...
      <div className="mt-14 rounded-2xl bg-foreground p-8 sm:p-10 text-center">
        <p className="text-sm font-mono text-background/50 uppercase tracking-widest mb-3">
          tried {projectName}?
        </p>
        <h3 className="text-xl sm:text-2xl font-bold text-background">
          leave your review on X
        </h3>
        <p className="mt-2 text-[15px] text-background/60 max-w-md mx-auto">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 rounded-full bg-accent px-6 py-3 text-[15px] font-bold text-background transition-colors hover:bg-accent/80"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 rounded-full border border-background/20 px-6 py-3 text-[15px] font-medium text-background transition-colors hover:bg-background/10"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
